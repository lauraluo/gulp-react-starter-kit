    ...
    _createClass(TodoApp, [{
        ...
        value: function render() {
            return React.createElement(
                'div',
                null,
                React.createElement(_TodoList2.default, { items: this.state.items, onItemDone: this.markItemDone.bind(this) }),
                React.createElement(_TodoInput2.default, { onAddItem: this.addItem.bind(this) })
            );
        }
    }]);
...
},{"./TodoInput":2,"./TodoList":4}],2:[function(require,module,exports){
'use strict';
...
exports.default = function (_ref) {
    ...
    return React.createElement(
        ...
        items.map(function (item, index) {
            return React.createElement(_TodoItem2.default, { key: index, item: item, onDone: onItemDone.bind(null, index) });
        })
    );
};

},{"./TodoItem":3}],5:[function(require,module,exports){
'use strict';
